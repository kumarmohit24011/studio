    ...
    <div className="container mx-auto px-4 py-12 md:py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
                <Truck className="h-6 w-6"/> Shipping Policy
            </CardTitle>
            ...
            <div>
             ...
             <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Standard Shipping (Free on orders over ₹1000):</strong> ₹50. Delivery in 5-7 business days.</li>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
                <Undo className="h-6 w-6"/> Return & Exchange Policy
            </CardTitle>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <div>
             ...
             <div>
              ...
              <p>To initiate a return, please email us at <a href="mailto:support@redbow.com" className="text-primary hover:underline">support@redbow.com</a> with your order number and reason for return.</p>
            </div>
          </CardContent>
        </Card>
      </div>
