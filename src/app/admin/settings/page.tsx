...
export default async function AdminSettingsPage() {
  ...
  const plainShippingSettings = {
    ...
    updatedAt: (siteContent.shippingSettings.updatedAt?.seconds && !isNaN(siteContent.shippingSettings.updatedAt.seconds)) 
      ? new Date(siteContent.shippingSettings.updatedAt.seconds * 1000).toISOString() 
      : undefined,
  };
